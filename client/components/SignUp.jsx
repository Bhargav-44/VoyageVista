...
const SignUp = ({ sign, setSign }) => {
  ...
  const {accessToken, setAccessToken, setUniqueName} = useGlobalContext()
  ...
  const handleSubmit = async (e) => {
    ...
    setAccessToken(result.message);
    setUniqueName(result.name);
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 text-[#1B1D1D]">
      ...
      >
        ...
        <div className="backdrop-blur-md bg-white/40 p-4 rounded-lg">
          <p className="text-2xl font-semibold mb-2">Welcome!👋</p>
